    ...
    return (
        <div className='descriptionbox'>
            ...
            <div className="descriptionbox-description">
                ...
                <p>
                   E-commerce websites typically display products or services along with detailed descriptions, images, prices and any available variations (e.g., sizes,colors). Each
                   product usually has it's own dedicated page with relevent information. 
                </p>
            </div>
        </div>
    );
